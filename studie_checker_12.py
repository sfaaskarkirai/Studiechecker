...
STUDIES = {
    "ATTAIN-OUTCOMES": {
        ...
        "samenvatting": (
            "**Sponsor:** Eli Lilly\n\n"
            "**Behandeling:** Orforglipron — een oraal, non-peptide GLP-1 receptor agonist (eenmaal daags) versus placebo.\n\n"
            "**Doel:** Cardiovasculaire uitkomsten verbeteren bij patiënten met obesitas én atherosclerotische cardiovasculaire ziekte (ASCVD) en/of chronische nierziekte (CKD).\n\n"
            "**Inclusie (samenvatting):** ≥50 jaar, BMI ≥25, aanwezigheid van ASCVD of CKD.\n\n"
            "**Belangrijkste exclusie:** eGFR <20, HbA1c >10% bij DM II, recent GLP-1 gebruik <90 dagen."
        ),
    ...
    "BaxDuo Prevent HF": {
        ...
        "samenvatting": (
            "**Sponsor:** AstraZeneca\n\n"
            "**Behandeling:** Baxdrostat (selectieve aldosteronsynthaseremmer) in combinatie met dapagliflozin (SGLT2-remmer) versus placebo + dapagliflozin.\n\n"
            "**Doel:** Voorkomen van hartfalen en cardiovasculaire sterfte bij patiënten met type 2 diabetes en CV disease.\n\n"
            "**Inclusie (samenvatting):** ≥40 jaar, T2DM, CV disease (CAD/CVD/PAD), SBP ≥130 mmHg, kalium 3.0–4.8 mmol/L, ≥1 aanvullende risicofactor.\n\n"
            "**Belangrijkste exclusie:** Bestaand hartfalen, eGFR <30, hyperkaliëmie."
        ),
        "check": check_baxduo,
    },
    "POLARIS NN9490-8266": {
        ...
        "samenvatting": (
            ...
            "**Behandeling:** GLP-1/GIP receptor agonist versus placebo als toevoeging aan standaardzorg.\n\n"
            "**Doel:** Verbetering van klinische uitkomsten bij patiënten met stabiel hartfalen met verlaagde ejectiefractie (HFrEF) én obesitas.\n\n"
            "**Inclusie (samenvatting):** ≥40 jaar, BMI ≥27, stabiel HF NYHA II–IV, LVEF ≤40%, verhoogd NT-proBNP (drempel afhankelijk van BMI en AF).\n\n"
            "**Belangrijkste exclusie:** eGFR <15, HbA1c >10% bij DM II, recent GLP-1 gebruik <90 dagen, hemodynamische instabiliteit."
        ),
        "check": check_polaris,
    },
    "ROXI-EVEREST": {
        ...
        "samenvatting": (
            "**Sponsor:** Regeneron\n\n"
            "**Behandeling:** REGN7508 — een monoklonaal antilichaam dat factor XI remt — versus standaard anticoagulantia.\n\n"
            "**Doel:** Preventie van trombo-embolische complicaties bij atriumfibrilleren met een gunstigere bloedingsprofiel dan huidige anticoagulantia.\n\n"
            "**Inclusie (samenvatting):** Permanente of paroxysmale AF/flutter met indicatie voor anticoagulantia, CHA2DS2-VA score ≥3 (of score 2 met aanvullende risicofactoren).\n\n"
            "**Belangrijkste exclusie:** Mechanische klepprothese, ernstige mitralisklepstenose, eGFR <15, SBP >180 mmHg."
        ),
    ...
    "AMBIENCE": {
        ...
        "samenvatting": (
            "**Sponsor:** Nog te bevestigen\n\n"
            "**Behandeling:** GLP-1/GIP receptor agonist versus placebo.\n\n"
            "**Doel:** Vermindering van cardiometabole risico's bij patiënten met ASCVD en obesitas.\n\n"
            "**Inclusie (samenvatting):** ≥45 jaar, BMI ≥27, ASCVD (MI/PAD/stroke), én ≥1 aanvullend risicocriterium (HF-opname <24mnd / eGFR<60 / UACR>30 / AF).\n\n"
            "**Belangrijkste exclusie:** DM type I, GLP-1/GIP gebruik <3 maanden, eGFR <15 of dialyse."
        ),
...
with col_resultaten:
    ...
    for naam, studie in STUDIES.items():
        ...
        with st.expander(f"ℹ️ Meer info over {naam}"):
            st.markdown(studie["samenvatting"])
